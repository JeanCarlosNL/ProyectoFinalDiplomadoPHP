        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #1f3c88">
                ...
                <div class="card-group">
                  ...
                  <?php foreach($newListado as $candidato): ?>
                    <div class="col-sm-3" >
                      <div class="card">
                      <a href="../dashboard.php?p=<?php echo $candidato->id;?>"><img src="<?php echo "../../administrador/Candidatos/" .$candidato->foto;?>"
                  ...
                  <div class="col-sm-3" >
                      <div class="card">
                      <a href="../dashboard.php?p=none"><img src="http://aytomengibar.com/wp-content/uploads/2019/04/generica-votaciones-votar-elecciones-democracia-745x450.jpg"
                              class="card-img-top" alt="..."></a>
                          <div class="card-body">
