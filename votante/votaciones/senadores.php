        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #1f3c88">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                      <h1 class="display-6 text-center">
                                <span class = "font-weight fuente_titulo" style="margin-left: 90px; color: white">Usted esta votando por SENADORES</span>
                      </h1>
                    </div>
                  </div>
                </nav> 
                ...
                <div class="card-group">
                  ...
                  <?php foreach($newListado as $candidato): ?>
                    <div class="col-sm-3" >
                      <div class="card">
                      <a href="../dashboard.php?s=<?php echo $candidato->id;?>"><img src="<?php echo "../../administrador/Candidatos/".$candidato->foto;?>"
                  ...
                  <div class="col-sm-3" >
                      <div class="card">
                          <a href="../dashboard.php?s=none"><img src="http://aytomengibar.com/wp-content/uploads/2019/04/generica-votaciones-votar-elecciones-democracia-745x450.jpg"
                              class="card-img-top" alt="..."></a>
                          <div class="card-body">
